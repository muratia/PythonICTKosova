...
class User:
    ...
    def __init__(self):  # class constructor
        ...
        self.id = "";  # initialization of the variable
        self.firstName = "";  # initialization of the variable
        self.lastName = "";  # initialization of the variable
        self.email = "";  # initialization of the variable
        self.password = "";  # initialization of the variable
        self.phone = "";  # initialization of the variable
